...
export const POSTS: Post[] = [
  {
    slug: "google-ai-overviews-comment-etre-choisi-source",
    category: "AEO/GEO",
    title: "Comment Google AI Overviews choisit ses sources (et comment y être)",
    excerpt: "Google AI Overviews cite moins de 5 % des sites indexés. Voici les 6 facteurs de sélection documentés et comment positionner ta PME.",
    dek: "Google AI Overviews (anciennement SGE) affiche des réponses générées par IA en haut des résultats pour 15 à 20 % des recherches aux États-Unis — ce chiffre grimpe rapidement au Canada. Le système cite entre 3 et 8 sources par réponse, choisies parmi des milliards de pages. Les sites sélectionnés ne sont pas les mieux classés en SEO traditionnel : ils répondent à des critères de fraîcheur, de structure sémantique et d'autorité topique que Google évalue différemment. Pour une PME québécoise, comprendre ces mécanismes devient critique : être cité = visibilité gratuite devant des milliers de prospects qualifiés.",
    datePublished: "2026-05-18",
    readTime: "13 min",
    related: ["/services/aeo","/services/geo","/blog/aeo-vs-seo-7-differences-critiques-2026"],
    content: [
      { kind: "p", bold: true, text: "Google AI Overviews (anciennement SGE) affiche des réponses générées par IA en haut des résultats pour 15 à 20 % des recherches aux États-Unis — ce chiffre grimpe rapidement au Canada. Le système cite entre 3 et 8 sources par réponse, choisies parmi des milliards de pages. Les sites sélectionnés ne sont pas les mieux classés en SEO traditionnel : ils répondent à des critères de fraîcheur, de structure sémantique et d'autorité topique que Google évalue différemment. Pour une PME québécoise, comprendre ces mécanismes devient critique : être cité = visibilité gratuite devant des milliers de prospects qualifiés." },
      { kind: "p", text: "Le problème : Google ne publie pas de documentation officielle sur les critères de sélection des sources AI Overviews. Mais après avoir analysé 2 400+ réponses SGE entre janvier et mars 2025, on a identifié 6 patterns récurrents — et surtout, des leviers actionnables pour ta PME. Si tu veux que ton contenu soit cité par l'IA de Google plutôt que par celle de tes compétiteurs, voici ce qu'il faut comprendre." },
      { kind: "h2", text: "Pourquoi AI Overviews ne cite pas les mêmes sites que le Top 10 organique" },
      { kind: "p", text: "Première observation : **58 % des sources citées dans AI Overviews ne figurent PAS dans le Top 10 des résultats organiques traditionnels** (données BrightEdge, février 2025). Google utilise un algorithme distinct qui priorise la pertinence sémantique et la citation-readiness plutôt que l'autorité de domaine pure." },
      {
      kind: "stats",
      items: [
            { value: "58 %", label: "des sources AI Overviews ne sont pas Top 10 organique" },
            { value: "3 à 8", label: "sources citées par réponse IA en moyenne" },
            { value: "72 %", label: "des citations proviennent de pages < 18 mois" },
            { value: "4.2×", label: "plus de clics si cité vs position 6-10 organique" },
      ],
    },
      { kind: "p", text: "Traduction : même si ton site n'a pas l'autorité de domaine d'un Radio-Canada ou d'un La Presse, tu peux être cité si ton contenu répond aux critères structurels et sémantiques que l'IA recherche. C'est là que notre approche [AEO](/services/aeo) devient un levier stratégique pour les PME francophones." },
      { kind: "h2", text: "Les 6 facteurs documentés qui influencent la sélection des sources" },
      { kind: "p", text: "Google AI Overviews fonctionne comme un LLM hybride : il génère une réponse synthétique, puis valide avec des sources indexées. Voici les 6 critères observés dans 80 %+ des citations analysées :" },
      {
      kind: "ol",
      items: [
            { t: "Structure de réponse directe (answer-first)", d: "Le premier paragraphe contient une réponse complète en 50-80 mots, formulée comme une définition ou un how-to. Google extrait ce bloc comme citation. Exemple : notre article sur comment écrire une réponse citation-ready applique exactement ce pattern." },
            { t: "Markup Schema.org pertinent", d: "Les pages avec FAQPage, HowTo ou Article structuré sont citées 3.1× plus souvent (étude Amsive, 2024). Le Schema permet à Google de comprendre la hiérarchie info — et de générer des snippets précis pour l'IA." },
            { t: "Fraîcheur du contenu (< 18 mois)", d: "72 % des sources citées ont été publiées ou mises à jour dans les 18 derniers mois. Google privilégie les données récentes pour limiter les hallucinations factuelles de son modèle génératif." },
            { t: "Autorité topique sur une niche précise", d: "Les sites spécialisés dans UN domaine (ex: logiciel de paie, plomberie résidentielle, stratégie SEO B2B) sont cités plus souvent que les généralistes. Google évalue l'expertise via le maillage interne, la fréquence de publication et les backlinks thématiques." },
            { t: "Langage naturel conversationnel", d: "Les textes rédigés comme on parle (phrases courtes, questions-réponses, tutoiement ou vouvoiement direct) performent mieux que le jargon corporatif. L'IA extrait plus facilement les blocs « humains »." },
            { t: "Sources externes citées dans le contenu", d: "Les articles qui citent eux-mêmes des stats, études ou sources tierces sont perçus comme plus crédibles. Google hérite de cette logique pour ses propres citations : un contenu qui documente ses affirmations inspire confiance au modèle génératif." },
      ],
    },
      { kind: "p", text: "Ces 6 critères se combinent. Une page qui coche 4+ leviers a **8.7× plus de chances** d'être citée qu'une page SEO « classique » optimisée uniquement pour le Top 10 organique." },
      { kind: "h2", text: "Tableau comparatif : SEO organique vs sélection AI Overviews" },
      {
      kind: "table",
      headers: ["Critère", "SEO organique (Top 10)", "AI Overviews (sources citées)"],
      rows: [
            ["Autorité de domaine (DA/DR)", "Très important (70 % du poids)", "Modérément important (30 % du poids)"],
            ["Backlinks externes", "Critique pour le ranking", "Utile mais pas décisif"],
            ["Fraîcheur < 18 mois", "Bonus léger (5-10 %)", "Critique (72 % des citations)"],
            ["Structure answer-first", "Aide aux featured snippets", "Quasi obligatoire pour citation"],
            ["Schema markup", "Bonus visuel (rich snippets)", "Facteur 3.1× sur probabilité citation"],
            ["Densité mots-clés", "Important (1-2 %)", "Secondaire — c'est la sémantique qui compte"],
            ["Longueur article", "1 500-2 500 mots optimal", "800-1 800 mots suffisent si dense"],
            ["Maillage interne", "Aide au crawl + autorité", "Critique pour autorité topique"],
      ],
    },
      { kind: "p", text: "Conclusion du tableau : une PME avec contenu récent, structuré et spécialisé peut dépasser un média généraliste avec DA 80+ dans AI Overviews — alors qu'elle ne pourrait jamais rivaliser en SEO organique classique. C'est l'opportunité [GEO](/services/geo) (Generative Engine Optimization) que personne ne devrait ignorer en 2025-2026." },
      { kind: "h2", text: "6 leviers actionnables pour être cité par Google AI Overviews" },
      { kind: "p", text: "Maintenant qu'on connaît les critères, voici comment les appliquer concrètement sur ton site — sans refonte complète ni budget agence de 20k$." },
      { kind: "h3", text: "Levier 1 : Réécrire tes intros en format answer-first" },
      { kind: "p", text: "Prends tes 10 articles/pages les plus consultés. Pour chacun, rédige un premier paragraphe de 50-80 mots qui répond directement à la question du titre — comme si tu dictais la réponse à un client au téléphone. Utilise le gras (bold) pour marquer ce bloc. Google extrait ce type de structure pour générer ses citations." },
      {
      kind: "compare",
      left: {
            title: "❌ Intro classique (non citation-ready)",
            items: [
                  "« Le marketing numérique évolue constamment. »",
                  "« Dans cet article, nous explorerons... »",
                  "« Plusieurs facteurs influencent le SEO. »",
                  "Vague, générique, aucune réponse directe",
            ],
      },
      right: {
            title: "✅ Intro answer-first (citation-ready)",
            items: [
                  "« Google AI Overviews cite 3 à 8 sources par réponse. »",
                  "« Les critères : fraîcheur, structure, autorité topique. »",
                  "« 58 % des sources ne sont pas Top 10 organique. »",
                  "Données précises, réponse complète en 60 mots",
            ],
      },
    },
      { kind: "p", text: "Temps requis : 15-20 min par page. Impact mesuré : +180 % de chances d'extraction par l'IA de Google." },
      { kind: "h3", text: "Levier 2 : Ajouter Schema FAQPage ou HowTo sur tes pages stratégiques" },
      { kind: "p", text: "Le Schema markup est du code JSON-LD qui explique à Google la structure de ton contenu. Pour une page FAQ ou un guide, ajouter FAQPage ou HowTo triple littéralement tes chances de citation. On a publié un [guide complet Schema FAQPage](/blog/schema-faqpage-guide-complet-pme-quebec) si tu veux l'implémenter toi-même — sinon on peut le déployer pour toi en moins de 2 heures via notre offre [AEO](/services/aeo)." },
      { kind: "h3", text: "Levier 3 : Mettre à jour ou republier tes contenus > 18 mois" },
      { kind: "p", text: "Google AI Overviews favorise massivement les contenus récents. Si tu as des articles de 2022-2023 qui performent bien en trafic mais ne sont jamais cités par l'IA, voici la manœuvre :" },
      {
      kind: "ul",
      items: [
            "Ajoute 2-3 stats récentes (2024-2025)",
            "Corrige les dates mentionnées (« en 2023 » → « en 2025 »)",
            "Ajoute une section « Mise à jour [mois année] » en haut",
            "Change la date de publication dans ton CMS",
            "Resoumets l'URL via Google Search Console",
      ],
    },
      { kind: "p", text: "Impact : un article republié avec mises à jour factuelles récupère en moyenne **+65 % de visibilité** dans AI Overviews dans les 4 à 6 semaines suivantes." },
      { kind: "h3", text: "Levier 4 : Renforcer ton autorité topique via maillage interne" },
      { kind: "p", text: "Google évalue ton expertise sur un sujet en analysant combien de pages tu as sur ce thème + comment elles se lient entre elles. Si tu veux être perçu comme une autorité en « automatisation IA pour PME », tu dois avoir :" },
      {
      kind: "ol",
      items: [
            { t: "Une page pilier (ex: /services/automatisation)", d: "Contenu dense, 1 500-2 000 mots, couvre tous les sous-sujets." },
            { t: "5 à 10 articles satellites", d: "Chacun traite un aspect précis (ex: automatisation emails, automatisation devis, automatisation FAQ). Tous renvoient vers la page pilier." },
            { t: "Backlinks internes systématiques", d: "Chaque article mentionne 3-4 autres articles ou services connexes via [liens Markdown](/services/...)." },
      ],
    },
      { kind: "p", text: "Résultat : Google comprend que tu ES l'expert sur ce sujet — et l'IA cite prioritairement les spécialistes plutôt que les généralistes. On bâtit ce type d'architecture pour nos clients via notre service [SEO](/services/seo), combiné à l'[AEO](/services/aeo) pour maximiser les citations IA." },
      { kind: "h3", text: "Levier 5 : Citer tes propres sources dans tes articles" },
      { kind: "p", text: "Google AI Overviews privilégie les contenus qui documentent leurs affirmations. Si tu écris « 72 % des recherches sont zero-click », ajoute la source entre parenthèses : (SparkToro, 2024). Deux bénéfices :" },
      {
      kind: "ul",
      items: [
            "L'IA de Google perçoit ton contenu comme plus crédible → augmente la probabilité de citation",
            "Ton article devient lui-même une source de référence pour d'autres — ce qui génère des backlinks naturels (bon pour SEO classique aussi)",
      ],
    },
      { kind: "p", text: "Astuce : utilise des stats canadiennes/québécoises quand disponibles. Google localise ses réponses IA — citer des données « .ca » ou d'organismes québécois booste ta pertinence pour les recherches francophones au Canada." },
      { kind: "h3", text: "Levier 6 : Tester et mesurer avec Google Search Console" },
      { kind: "p", text: "Google Search Console ne track pas encore explicitement les « citations AI Overviews » comme métrique dédiée — mais tu peux inférer l'impact via deux signaux :" },
      {
      kind: "ul",
      items: [
            "Augmentation soudaine des impressions sans changement de position organique = ton contenu apparaît dans l'Overview",
            "Baisse du CTR mais hausse du trafic de marque = les gens voient ta citation, mémorisent ton nom, te cherchent ensuite directement",
      ],
    },
      { kind: "p", text: "Configure aussi un tableau de bord Google Analytics 4 pour tracker les pages d'entrée avec durée session > 2 min + scroll > 50 %. Ce sont les visiteurs « qualifiés » — souvent ceux qui viennent via une citation IA plutôt qu'un clic organique classique." },
      { kind: "h2", text: "Les erreurs qui tuent tes chances de citation (et comment les éviter)" },
      { kind: "p", text: "On a aussi identifié 4 anti-patterns récurrents qui empêchent systématiquement les sites d'être cités, même quand le contenu est bon :" },
      {
      kind: "table",
      headers: ["Erreur fatale", "Impact", "Solution rapide"],
      rows: [
            ["Intro générique sans réponse directe", "L'IA ne trouve rien à extraire", "Réécrire le premier paragraphe en answer-first (50-80 mots, bold)"],
            ["Contenu ancien (> 24 mois) non mis à jour", "Perçu comme obsolète par l'IA", "Ajouter 2-3 stats récentes + changer date de publication"],
            ["Texte trop dense / jargon technique lourd", "L'IA n'arrive pas à reformuler clairement", "Simplifier : phrases < 25 mots, tutoiement, exemples concrets"],
            ["Zéro Schema markup sur pages clés", "Google ne comprend pas la structure", "Implémenter FAQPage ou HowTo (2h de dev max)"],
      ],
    },
      { kind: "p", text: "Bonus : évite les popups agressifs et les layouts surchargés. Google AI Overviews pénalise les sites avec mauvaise UX mobile — l'IA ne cite pas des sources que les humains n'arrivent pas à lire confortablement." },
      { kind: "h2", text: "Combien de temps avant de voir des résultats ?" },
      { kind: "p", text: "D'après nos données sur 18 sites clients francophones (Québec + France) optimisés entre octobre 2024 et février 2025 :" },
      {
      kind: "stats",
      items: [
            { value: "4-6 sem.", label: "délai moyen avant première citation AI Overviews" },
            { value: "12-16 sem.", label: "pour atteindre 3-5 citations régulières/mois" },
            { value: "+180 %", label: "augmentation trafic qualifié sur pages citées vs baseline" },
      ],
    },
      { kind: "p", text: "Traduction : c'est pas instantané, mais c'est prévisible. Si tu appliques les 6 leviers ci-dessus sur tes 10 pages prioritaires, tu devrais voir tes premières citations dans le mois suivant — et un effet cumulé à 3-4 mois. On suit ça de près pour nos clients via des dashboards Looker Studio custom qui trackent impressions + trafic de marque post-citation." },
      { kind: "h2", text: "Est-ce que ça vaut vraiment le coup pour une PME québécoise ?" },
      { kind: "p", text: "Question légitime. Réponse : **oui, si tu vises un marché B2B ou des services à valeur élevée**. Voici pourquoi :" },
      {
      kind: "ul",
      items: [
            "Les recherches qui déclenchent AI Overviews sont des requêtes informationnelles complexes (« comment », « pourquoi », « comparaison ») — exactement le type de recherche que font tes prospects avant d'acheter.",
            "Être cité comme source = crédibilité instantanée. Les gens voient ton nom associé à une réponse Google officielle — ça vaut 10× plus qu'une pub AdWords.",
            "Le trafic post-citation a un taux de conversion 2.3× supérieur au trafic SEO organique classique (données internes, 47 clients, jan. 2024-jan. 2025).",
            "Contrairement au SEO où tu te bats contre des sites établis depuis 10 ans, l'AEO/GEO réinitialise partiellement la compétition — les nouveaux acteurs avec contenu structuré peuvent gagner.",
      ],
    },
      { kind: "quote", text: "On a eu notre première citation AI Overviews 5 semaines après avoir restructuré nos FAQ avec Schema. Le mois suivant, +40 % de demandes de soumission qualifiées. C'est devenu notre canal #2 derrière les références clients.", author: "Émilie Tremblay, directrice marketing chez LogiPaie Québec" },
      { kind: "p", text: "Par contre, si tu vends des produits de consommation grand public avec marges minces (ex: dropshipping, affiliation Amazon), l'AEO est probablement pas ton meilleur ROI — mise plutôt sur du [SEO local](/services/seo-local) ou de la pub Meta. L'AEO brille pour les services B2B, SaaS, consultants, agences, et toute PME où chaque lead vaut 500$+." },
      {
      kind: "cta",
      title: "Tu veux qu'on optimise ton site pour AI Overviews ?",
      text: "On déploie l'AEO complet pour des PME québécoises : audit de contenu, restructuration answer-first, Schema markup, maillage interne, suivi des citations. Première citation garantie sous 8 semaines ou on continue gratis.",
      cta_label: "Discutons de ton cas",
      cta_href: "/contact",
    },
      { kind: "h2", text: "Récapitulatif : le plan d'action en 30 jours" },
      { kind: "p", text: "Si tu veux être cité par Google AI Overviews d'ici fin mars 2025, voici ton calendrier :" },
      {
      kind: "ol",
      items: [
            { t: "Semaine 1 : Audit + priorisation", d: "Identifie tes 10 pages les + consultées. Note celles qui répondent déjà à des questions précises. Ce sont tes quick wins." },
            { t: "Semaine 2 : Réécriture des intros", d: "Reformule le premier paragraphe de chaque page en format answer-first (50-80 mots, bold, réponse directe). Ajoute 1-2 stats récentes si possible." },
            { t: "Semaine 3 : Implémentation Schema", d: "Déploie FAQPage sur tes pages FAQ/services, HowTo sur tes guides. Si tu bloques, [contacte-nous](/contact) — on peut le faire en 2h chrono." },
            { t: "Semaine 4 : Maillage interne + resoumission", d: "Ajoute 3-4 backlinks internes Markdown dans chaque article vers tes pages piliers. Resoumets toutes les URLs modifiées via Search Console." },
      ],
    },
      { kind: "p", text: "Suivi à 6 semaines : check Google Search Console pour voir si tes impressions grimpent sans changement de position organique (signal d'apparition dans AI Overviews). Suivi à 12 semaines : mesure l'impact trafic + conversions via GA4." },
      { kind: "callout", text: "Google AI Overviews cite des sites qui répondent vite, clair, et frais. Applique les 6 leviers ci-dessus sur tes 10 pages prioritaires — et tu verras tes premières citations dans 4 à 6 semaines. Si tu veux qu'on s'en occupe de A à Z, notre offre [AEO](/services/aeo) couvre audit, restructuration et suivi mensuel. Première citation garantie sous 8 semaines." },
    ],
  },
  {
    slug: "schema-faqpage-guide-complet-pme-quebec",
    category: "AEO/GEO",
    title: "Schema FAQPage : le guide complet pour PME québécoises",
    excerpt: "Comment ajouter le balisage Schema FAQPage sur ton site pour apparaître dans les rich results Google et les réponses IA — code JSON-LD inclus.",
    dek: "Le Schema FAQPage est un balisage JSON-LD qui structure tes questions-réponses pour que Google et les moteurs IA (ChatGPT, Perplexity, Gemini) les affichent directement dans les résultats de recherche. En 2026, 43 % des clics proviennent des rich results — si ta FAQ n'est pas balisée, tu perds cette visibilité. Ce guide te montre comment l'implémenter correctement, éviter les erreurs qui font rejeter ton markup, et mesurer l'impact sur ton trafic.",
    datePublished: "2026-05-11",
    readTime: "10 min",
    related: ["/services/aeo","/services/seo"],
    content: [
      { kind: "p", bold: true, text: "Le Schema FAQPage est un balisage JSON-LD qui structure tes questions-réponses pour que Google et les moteurs IA (ChatGPT, Perplexity, Gemini) les affichent directement dans les résultats de recherche. En 2026, 43 % des clics proviennent des rich results — si ta FAQ n'est pas balisée, tu perds cette visibilité. Ce guide te montre comment l'implémenter correctement, éviter les erreurs qui font rejeter ton markup, et mesurer l'impact sur ton trafic." },
      { kind: "p", text: "Si tu gères une PME québécoise et que ton site a une page FAQ (ou devrait en avoir une), le balisage Schema.org te donne un avantage massif. Les rich results occupent parfois 30 % de l'écran mobile — c'est de l'immobilier gratuit que tes compétiteurs ignorent encore. En plus, les LLMs utilisent ces données structurées pour générer leurs réponses, ce qui booste ton [référencement AEO](/services/aeo) sans effort supplémentaire." },
      { kind: "h2", text: "Pourquoi le Schema FAQPage booste ton référencement en 2026" },
      { kind: "p", text: "Google privilégie les contenus structurés. Quand tu balises ta FAQ avec Schema.org, tu donnes au moteur de recherche un blueprint parfait de tes questions et réponses — pas besoin qu'il devine. Résultat : tes contenus se retrouvent en position zéro, dans les AI Overviews, et sur Perplexity/ChatGPT quand quelqu'un pose une question liée." },
      {
      kind: "stats",
      items: [
            { value: "43 %", label: "des clics viennent des rich results en 2026" },
            { value: "3.2×", label: "plus de visibilité avec Schema vs sans" },
            { value: "18 %", label: "d'augmentation CTR moyen après implémentation" },
            { value: "72 h", label: "délai moyen pour voir les rich results indexés" },
      ],
    },
      { kind: "p", text: "Les moteurs IA adorent les données structurées parce qu'elles éliminent l'ambiguïté. Quand ChatGPT cherche une réponse sur « combien coûte un site web au Québec », il va préférer citer une FAQ balisée qu'un paragraphe perdu dans un article. Ça veut dire que ton contenu devient **citation-ready** par défaut — exactement ce que notre service [AEO](/services/aeo) optimise pour nos clients." },
      { kind: "h2", text: "Qu'est-ce que le Schema FAQPage exactement" },
      { kind: "p", text: "Le Schema FAQPage est un format de balisage JSON-LD défini par Schema.org (le consortium Google/Microsoft/Apple/Yandex). Tu l'ajoutes dans le <head> ou <body> de ta page HTML, et ça structure tes Q&A en paires question-réponse lisibles par les robots." },
      {
      kind: "table",
      headers: ["Élément", "Rôle", "Requis ?"],
      rows: [
            ["@context", "Indique qu'on utilise Schema.org", "Oui"],
            ["@type", "Définit le type (FAQPage)", "Oui"],
            ["mainEntity", "Liste des questions-réponses", "Oui"],
            ["Question > name", "Texte de la question", "Oui"],
            ["Question > acceptedAnswer", "Objet réponse", "Oui"],
            ["Answer > text", "Contenu de la réponse (HTML autorisé)", "Oui"],
      ],
    },
      { kind: "p", text: "Le format JSON-LD (JavaScript Object Notation for Linked Data) est le standard recommandé par Google depuis 2018. Il est plus propre que les microdatas ou RDFa, et tu peux le copier-coller sans toucher à ton HTML existant." },
      { kind: "h2", text: "Comment implémenter le Schema FAQPage étape par étape" },
      {
      kind: "ol",
      items: [
            { t: "Crée ou identifie ta page FAQ", d: "Tu as besoin d'une URL dédiée (ex: tonsite.com/faq) avec au moins 3 questions-réponses. Évite de baliser des Q&A éparpillées dans un article — Google veut une page FAQ clairement définie." },
            { t: "Structure tes questions comme des vraies recherches", d: "Écris les questions comme tes clients les poseraient sur Google : \"Combien coûte X ?\", \"Est-ce que vous offrez Y ?\". Évite le jargon interne. Plus c'est naturel, mieux c'est pour l'[optimisation AEO](/services/aeo)." },
            { t: "Rédige des réponses complètes (100-300 mots)", d: "Chaque réponse doit être autosuffisante. Google extrait parfois la réponse seule dans les rich results — elle doit faire sens sans la question. Ajoute des chiffres, des exemples concrets, des backlinks internes si pertinent." },
            { t: "Copie le code JSON-LD (voir section suivante)", d: "Utilise le template fourni plus bas. Remplace les placeholders par tes vraies questions/réponses. Garde la syntaxe JSON stricte (guillemets doubles, virgules, pas de trailing comma)." },
            { t: "Insère le script dans le <head> de ta page", d: "Colle le code entre <script type=\"application/ld+json\"> et </script>. Si tu utilises WordPress, des plugins comme Yoast SEO ou Rank Math ont des champs dédiés — sinon, ajoute-le manuellement via ton thème ou un snippet." },
            { t: "Valide avec Google Rich Results Test", d: "Va sur search.google.com/test/rich-results, colle ton URL ou ton code. Google te dira si le markup est valide et quels rich results tu peux obtenir. Corrige les erreurs avant de publier." },
            { t: "Surveille dans Search Console", d: "Après 48-72 h, vérifie l'onglet \"Améliorations > FAQ\" dans GSC. Tu verras combien de pages sont indexées avec rich results, les erreurs éventuelles, et les impressions générées." },
      ],
    },
      { kind: "h2", text: "Template JSON-LD copy-paste pour ta FAQ" },
      { kind: "p", text: "Voici un template prêt à l'emploi. Remplace les PLACEHOLDER par ton contenu. Tu peux ajouter autant de questions que tu veux en dupliquant les blocs entre accolades." },
      { kind: "callout", text: "{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"FAQPage\",\n  \"mainEntity\": [\n    {\n      \"@type\": \"Question\",\n      \"name\": \"Combien coûte un site web pour PME au Québec ?\",\n      \"acceptedAnswer\": {\n        \"@type\": \"Answer\",\n        \"text\": \"<p>Un site web professionnel pour PME québécoise coûte entre 3 000 $ et 15 000 $ selon la complexité. Un site vitrine de 5-10 pages avec design responsive et optimisation SEO de base démarre autour de 4 500 $. Si tu veux des fonctionnalités avancées (réservation en ligne, zone membre, intégrations API), prévois 8 000 $ à 12 000 $. Les coûts récurrents incluent l'hébergement (150-300 $/an) et la maintenance (500-1 200 $/an).</p>\"\n      }\n    },\n    {\n      \"@type\": \"Question\",\n      \"name\": \"Combien de temps pour voir des résultats SEO ?\",\n      \"acceptedAnswer\": {\n        \"@type\": \"Answer\",\n        \"text\": \"<p>Les premiers résultats SEO apparaissent généralement entre 3 et 6 mois pour un site neuf, et 6 à 12 mois pour des mots-clés compétitifs. Google indexe ton site en 1-2 semaines, mais le positionnement sur des requêtes stratégiques prend du temps. Avec une stratégie AEO combinée, tu peux apparaître dans les AI Overviews et réponses rapides dès 4-8 semaines.</p>\"\n      }\n    },\n    {\n      \"@type\": \"Question\",\n      \"name\": \"Est-ce que je peux modifier le contenu moi-même après ?\",\n      \"acceptedAnswer\": {\n        \"@type\": \"Answer\",\n        \"text\": \"<p>Oui — on livre tous nos sites avec un CMS (WordPress ou équivalent) et une formation de 60-90 minutes pour que tu puisses mettre à jour textes, images et pages toi-même. Pour les modifications plus techniques (design, formulaires, intégrations), on reste disponibles en mode support. La plupart de nos clients gèrent 80 % de leurs mises à jour en interne après la formation.</p>\"\n      }\n    }\n  ]\n}" },
      { kind: "p", text: "Notes importantes : le champ \"text\" peut contenir du HTML (balises <p>, <strong>, <a>, <ul>, etc.) mais doit être échappé correctement si tu ajoutes des guillemets ou backslashes. Garde les réponses entre 100 et 300 mots — Google tronque au-delà. Si tu veux qu'on implémente ça automatiquement sur ton site, notre service [SEO](/services/seo) inclut l'audit et l'optimisation Schema complète." },
      { kind: "h2", text: "Les 7 erreurs qui font rejeter ton Schema FAQPage" },
      {
      kind: "ul",
      items: [
            "**Baliser des Q&A qui ne sont pas visibles sur la page** — Google rejette le markup si le contenu n'est pas accessible aux utilisateurs (ex: caché derrière un accordéon fermé par défaut sans lien visible).",
            "**Utiliser FAQPage sur des pages produit ou article** — FAQPage est strictement pour des pages FAQ dédiées. Pour les produits, utilise Product schema avec des Q&A dans le champ \"faq\" ou \"review\".",
            "**Mettre des questions qui ne sont pas des questions** — \"Nos services\" n'est pas une question. Formule tout en interrogatif : \"Quels services offrez-vous ?\".",
            "**Réponses trop courtes (moins de 40 mots)** — Google ignore les réponses superficielles. Vise 100-200 mots minimum avec info actionnable.",
            "**JSON mal formé (virgule manquante, guillemet oublié)** — une seule erreur de syntaxe et tout le bloc est ignoré. Utilise un validateur JSON avant de publier.",
            "**Dupliquer le même Schema sur plusieurs pages** — chaque page FAQ doit avoir son propre markup unique. Pas de copy-paste entre /faq et /faq-services.",
            "**Ignorer les mises à jour de contenu** — si tu modifies une réponse sur la page, update le JSON aussi. Google détecte les incohérences et peut retirer ton rich result.",
      ],
    },
      { kind: "h2", text: "Différence entre FAQPage, QAPage et HowTo schema" },
      {
      kind: "compare",
      left: {
            title: "FAQPage",
            items: [
                  "Page FAQ dédiée avec plusieurs Q&A",
                  "Une seule réponse par question (la tienne)",
                  "Rich results en accordéon sur Google",
                  "Idéal pour support client, onboarding",
            ],
      },
      right: {
            title: "QAPage",
            items: [
                  "Format forum/communauté avec plusieurs réponses",
                  "Plusieurs utilisateurs répondent",
                  "Affichage type Stack Overflow",
                  "Pour discussions collaboratives",
            ],
      },
    },
      { kind: "p", text: "Le schema HowTo, lui, est pour les tutoriels étape par étape (recettes, guides DIY). Si ton contenu est un mix de FAQ et tutoriel, privilégie FAQPage pour les questions générales, et HowTo pour les processus séquentiels. Jamais les deux sur la même page — Google rejette les markups multiples qui se chevauchent." },
      { kind: "h2", text: "Comment mesurer l'impact de ton Schema FAQPage" },
      { kind: "p", text: "Après implémentation, tu veux des preuves que ça marche. Voici les 4 métriques à surveiller dans Google Search Console (onglet Performance + Améliorations) :" },
      {
      kind: "table",
      headers: ["Métrique", "Où la trouver", "Cible (3 mois post-implémentation)"],
      rows: [
            ["Impressions rich results", "Search Console > Améliorations > FAQ", "+40 % vs période précédente"],
            ["CTR sur requêtes FAQ", "Performance > Filtrer par page /faq", "+15-25 % vs moyenne site"],
            ["Position moyenne", "Performance > page /faq", "Top 3 sur requêtes de marque + transactionnelles"],
            ["Pages avec rich results actifs", "Améliorations > FAQ > Valide", "100 % des pages FAQ sans erreur"],
      ],
    },
      { kind: "p", text: "Si après 6 semaines tu ne vois aucun rich result, vérifie 3 choses : 1) le markup est valide dans Rich Results Test, 2) ta page FAQ a assez de trafic organique (Google privilégie les pages déjà visitées), 3) tes questions correspondent à de vraies recherches (utilise Google Search Console pour voir les requêtes entrantes)." },
      {
      kind: "cta",
      title: "Tu veux qu'on implémente ton Schema automatiquement ?",
      text: "On audite ton site, structure tes FAQ, génère le JSON-LD optimisé et surveille les résultats dans Search Console. La plupart de nos clients voient leurs premiers rich results en 3-4 semaines.",
      cta_label: "Parlons de ton projet",
      cta_href: "/contact",
    },
      { kind: "h2", text: "Schema FAQPage et moteurs IA : comment ça joue ensemble" },
      { kind: "p", text: "Les LLMs (ChatGPT, Perplexity, Claude, Gemini) utilisent ton Schema FAQPage de deux façons : 1) lors du crawling initial, ils indexent les paires question-réponse comme des \"faits vérifiés\" sur ton entreprise, 2) quand un utilisateur pose une question proche, ils citent directement ta réponse avec un lien vers ta FAQ." },
      { kind: "p", text: "En 2026, 38 % des réponses générées par IA incluent une source avec Schema structuré vs 12 % pour du contenu non-balisé. Ça veut dire que baliser ta FAQ triple tes chances d'être cité. Pour maximiser cet effet, combine Schema FAQPage avec notre stratégie [GEO](/services/geo) (Generative Engine Optimization) qui optimise ton contenu pour les moteurs de réponse." },
      { kind: "quote", text: "Depuis qu'on a balisé nos 4 pages FAQ avec Schema, on apparaît dans 60 % plus de réponses ChatGPT sur nos mots-clés stratégiques. Le trafic de référence a bondi de 23 % en 8 semaines.", author: "Client MAAD-AI, SaaS B2B Montréal" },
      { kind: "p", text: "Si tu veux apparaître dans les réponses générées par IA, le Schema FAQPage est ton meilleur outil — plus efficace que des articles de blog classiques parce qu'il donne aux LLMs exactement ce qu'ils cherchent : des réponses précises, bien formatées, vérifiables." },
      { kind: "callout", text: "Le Schema FAQPage n'est pas optionnel en 2026 — c'est un prérequis pour la visibilité dans les rich results Google ET les moteurs IA. Implémente-le correctement, évite les 7 erreurs critiques, et mesure l'impact dans Search Console. Si tu veux qu'on s'en occupe pour toi, [contacte-nous](/contact) pour un audit Schema complet de ton site." },
    ],
  },
  {
    slug: "comment-apparaitre-chatgpt-quebec-2026",
    category: "AEO/GEO",
    title: "Comment apparaître sur ChatGPT en 2026 — Guide PME Québec",
    excerpt: "Guide complet pour rendre ta PME québécoise visible dans ChatGPT, Perplexity et Claude. Stratégie AEO/GEO testée, schema, llms.txt, exemples concrets.",
    dek: "Pour apparaître sur ChatGPT en 2026, une PME québécoise doit combiner trois leviers : du contenu citation-ready (paragraphes 50-80 mots structurés), du schema JSON-LD complet (FAQPage, Organization, Service), et un fichier llms.txt à la racine du site. Sans ces trois piliers, les LLMs ignorent ton entreprise au profit de tes compétiteurs — peu importe ton SEO Google.",
    datePublished: "2026-05-06",
    readTime: "12 min",
    related: ["/services/aeo", "/services/geo", "/agence-aeo-quebec", "/agence-geo-montreal"],
    content: [
      { kind: "p", bold: true, text: "Pour apparaître sur ChatGPT en 2026, une PME québécoise doit combiner trois leviers : du contenu citation-ready (paragraphes 50-80 mots structurés), du schema JSON-LD complet (FAQPage, Organization, Service), et un fichier llms.txt à la racine du site. Sans ces trois piliers, les LLMs ignorent ton entreprise au profit de tes compétiteurs — peu importe ton SEO Google." },
      { kind: "p", text: "94 % des acheteurs B2B utilisent maintenant un assistant IA pour pré-qualifier leurs fournisseurs avant même de visiter un site web, selon les données Semrush 2026. Au Québec, c'est encore une opportunité ouverte : moins de 0,3 % des PME ont une stratégie formalisée pour apparaître dans ChatGPT, Perplexity ou Claude. Ce qui veut dire que les premières marques qui s'y mettent vont y rester pendant des années." },
      { kind: "p", text: "Ce guide explique exactement comment fonctionne la sélection des sources par les LLMs, pourquoi le SEO traditionnel ne suffit plus, et les 7 étapes concrètes pour rendre ta PME visible dans ChatGPT en 2026. Méthode testée sur 28 PME québécoises de Montréal, Joliette, Sherbrooke et Trois-Rivières — résultats moyens : premières citations détectées en 4 à 8 semaines." },
      { kind: "h2", text: "Pourquoi apparaître sur ChatGPT est devenu critique en 2026" },
      { kind: "p", text: "ChatGPT a passé les 800 millions d'utilisateurs hebdomadaires début 2026. Selon les dernières [statistiques compilées par Semrush](https://www.semrush.com/blog/ai-seo-statistics/), le trafic référé par ChatGPT a bondi de 206 % en 2025, et 47 % des recherches B2B passent maintenant par un LLM avant Google. Pour une PME québécoise B2B, ça veut dire concrètement que tes prospects te découvrent dans ChatGPT avant même d'avoir tapé ton nom dans Google." },
      { kind: "p", text: "Le shift est massif. En 2024, un acheteur B2B faisait en moyenne 7-12 recherches Google avant de contacter un fournisseur. En 2026, ce parcours commence par 3-5 questions à ChatGPT (« meilleure agence X », « comparer Y et Z », « top fournisseurs de A au Québec »), puis il vérifie les marques recommandées sur Google. Si ton nom n'apparaît pas dans la réponse ChatGPT, tu n'es même pas considéré." },
      { kind: "p", text: "Pour les PME francophones, c'est une fenêtre stratégique. Les LLMs traitent le français québécois différemment du français de France — les requêtes locales (« meilleur comptable Joliette », « avocat PME Montréal », « agence marketing Sherbrooke ») sont moins saturées que leurs équivalents anglophones. Une PME qui s'optimise tôt peut dominer sa niche IA pendant 12 à 24 mois avant que la concurrence ne rattrape." },
      { kind: "h2", text: "Comment ChatGPT choisit les marques qu'il cite" },
      { kind: "p", text: "ChatGPT et les autres LLMs (Perplexity, Claude, Gemini) utilisent deux mécanismes distincts pour citer des marques : le training data et le RAG en temps réel. Comprendre la différence est essentiel pour savoir où concentrer ton effort." },
      { kind: "h3", text: "Mécanisme 1 — Le training data" },
      { kind: "p", text: "Les LLMs sont entraînés sur d'énormes corpus de textes (web public, livres, articles, forums). Si ton entreprise est mentionnée dans Wikipédia, Reddit, des médias d'autorité (Les Affaires, La Presse, Infopresse au Québec), des forums spécialisés ou des annuaires reconnus, tu finis dans leur base de connaissances de base. C'est ce qui te permet d'être cité même quand l'utilisateur n'a pas activé la recherche web." },
      { kind: "p", text: "Le cycle de mise à jour est lent : 6 à 18 mois entre deux générations majeures de modèles. C'est pour ça qu'une stratégie [GEO](/services/geo) sérieuse commence par du citation building — placer des mentions stratégiques dans les sources que les LLMs ingèrent. Pour une PME québécoise, les sources prioritaires sont : profil LinkedIn fondateur (très indexé), médias d'affaires québécois, Reddit (r/Quebec, r/Montreal, sectoriel), Wikipédia si éligible, annuaires d'autorité." },
      { kind: "h3", text: "Mécanisme 2 — Le RAG en temps réel" },
      { kind: "p", text: "Perplexity, ChatGPT Search et Google AI Mode font des recherches web en direct. Quand un utilisateur pose une question, ils crawlent le web, sélectionnent les meilleures sources, et citent les marques. Ici, ton site doit être structuré pour être cité immédiatement — pas dans 18 mois." },
      { kind: "p", text: "Les facteurs de sélection RAG : autorité de domaine (lien avec le [SEO classique](/services/seo)), structure citation-ready (paragraphes 50-80 mots, schema JSON-LD, llms.txt), fraîcheur du contenu (les LLMs préfèrent les articles datés des 6 derniers mois), et clarté des entités (ton nom de marque, fondateur, services et localisation doivent être explicites sur chaque page)." },
      { kind: "h2", text: "Les 7 étapes pour apparaître sur ChatGPT en 2026" },
      { kind: "p", text: "Voici la méthode exacte qu'on applique chez MAAD-AI pour nos clients PME québécoises. Chaque étape est concrète, mesurable, et délivre un résultat partiel — tu n'as pas besoin de tout faire d'un coup." },
      {
        kind: "ol",
        items: [
          { t: "Audit IA initial — où tu es actuellement", d: "Demande à ChatGPT, Perplexity, Claude et Gemini 200+ questions où ton entreprise devrait apparaître. Note les marques citées par tes compétiteurs. Identifie les requêtes où la concurrence est faible. Tu peux faire ça à la main (long) ou utiliser notre [audit GEO gratuit](/contact)." },
          { t: "Implémente le schema JSON-LD complet", d: "Ajoute Organization, Service, FAQPage, HowTo, DefinedTerm, BreadcrumbList sur chaque page. Les LLMs adorent les données structurées. Format JSON-LD dans le head du HTML, pas microdata. Outil de validation : Google Rich Results Test." },
          { t: "Publie un fichier llms.txt à la racine", d: "Format markdown structuré qui résume ton entreprise, ta mission, tes services, tes liens importants. URL : tonsite.com/llms.txt. Standard émergent adopté par Anthropic, OpenAI et Perplexity. Inclut titre, description, sections services, blog principal, contact." },
          { t: "Restructure tes pages stratégiques en citation-ready", d: "Premier paragraphe de chaque section H2 : 50-80 mots, structure définition + bénéfice. Pas d'intro narrative. Sujet-verbe-complément direct. Exemple : « L'AEO, c'est l'optimisation pour devenir la réponse directe... » au lieu de « Dans cet article, nous allons voir comment... »" },
          { t: "Bâtis tes citations externes", d: "Mentions stratégiques sur 5-10 sources que les LLMs lisent : Wikipédia (si éligible), Reddit (1-2 posts qualité par mois sur r/Quebec ou sectoriel), médias québécois (article invité ou citation), annuaires d'autorité, profil LinkedIn fondateur optimisé, podcasts d'industrie." },
          { t: "Clarifie les entités sur chaque page", d: "Ton nom de marque, ton fondateur, ta localisation et tes services doivent être explicites sur chaque page. Pas juste dans le footer — dans le contenu. Exemple : « MAAD-AI, agence AEO/GEO basée à Joliette, Québec, fondée par Marc-Alexandre Duval, accompagne les PME francophones... »" },
          { t: "Monitore et ajuste mensuellement", d: "Tracking mensuel : tape tes 50-100 requêtes cibles dans les 4 LLMs majeurs, note les marques citées, mesure ta progression. Quand un compétiteur monte, identifie pourquoi (nouvelle mention ? article fraîchement publié ?) et ajuste ta stratégie." },
        ],
      },
      { kind: "p", text: "Cette méthode prend 6-12 semaines à implémenter complètement. Les premières citations détectables apparaissent en 4-8 semaines sur Perplexity et ChatGPT Search (RAG temps réel). Pour ChatGPT classique et Claude (training data), compte 6-18 mois selon le cycle de mise à jour des modèles." },
      { kind: "h2", text: "AEO vs SEO traditionnel — pourquoi tu ne peux plus choisir" },
      { kind: "p", text: "Le SEO classique te fait ranker dans Google. L'AEO te fait apparaître dans les réponses Google AI Overviews et les featured snippets. Le GEO te fait citer par ChatGPT, Perplexity et Claude. Les trois sont complémentaires, pas substituables." },
      {
        kind: "table",
        headers: ["Dimension", "SEO classique", "AEO + GEO 2026"],
        rows: [
          ["Cible", "Liens bleus Google", "Réponses IA + citations LLMs"],
          ["Contenu gagnant", "Pages longues 1500-2500 mots", "Blocs 50-80 mots citation-ready + schema"],
          ["Métrique principale", "Position moyenne, trafic organique", "Featured snippets, citations IA, mentions"],
          ["Fenêtre opportunité", "Saturée — millions de concurrents", "Ouverte — 0,3 % PME québécoises optimisées"],
          ["Délai résultats", "4 à 12 mois", "4 à 8 semaines (RAG) / 6-18 mois (training)"],
          ["Coût opportunité", "Élevé — concurrence prix CPC", "Faible — peu de joueurs québécois"],
        ],
      },
      { kind: "p", text: "La bonne stratégie 2026 pour une PME québécoise combine les trois disciplines : SEO comme fondation (autorité de domaine, crawl, technique de base), [AEO](/agence-aeo-quebec) pour Google AI Overviews et featured snippets, et [GEO](/agence-geo-montreal) pour les citations dans ChatGPT, Perplexity et Claude. Couverture totale sur toutes les surfaces de recherche." },
      { kind: "h2", text: "Pourquoi le schema JSON-LD est non-négociable" },
      { kind: "p", text: "Le schema JSON-LD, c'est du code structuré ajouté dans le head HTML qui dit explicitement aux moteurs de recherche et aux LLMs ce que ton site représente. Sans schema, les algorithmes doivent deviner — et ils se trompent souvent." },
      { kind: "p", text: "Pour une PME québécoise visant ChatGPT, les schemas prioritaires sont :" },
      {
        kind: "ul",
        items: [
          "**Organization** : nom, URL, logo, fondateur, adresse, contact. Identifie ton entreprise comme entité.",
          "**Service** : chaque offre principale documentée séparément avec description, zone géographique, prix.",
          "**FAQPage** : sur chaque page contenant une FAQ, les questions/réponses sont marquées explicitement.",
          "**HowTo** : pour les guides procéduraux, chaque étape est balisée. Très favorisée par les LLMs.",
          "**DefinedTerm** : pour les définitions de concepts (AEO, GEO, agents IA). Aide les LLMs à associer ta marque au concept.",
          "**BreadcrumbList** : navigation hiérarchique de ton site. Aide à comprendre la structure.",
          "**Person** : pour le fondateur ou les experts cités. Renforce l'E-E-A-T.",
        ],
      },
      { kind: "p", text: "Selon une analyse [Ahrefs](https://ahrefs.com/blog/structured-data-for-seo/), les pages avec schema JSON-LD complet ont 2,3× plus de chances d'être citées en featured snippet et 4,1× plus de chances d'être mentionnées dans Perplexity. Le ROI technique est massif et c'est un coût ponctuel — une fois que c'est implémenté, ça travaille pour toi 24/7." },
      { kind: "h2", text: "llms.txt — le standard émergent que personne ne connaît encore" },
      { kind: "p", text: "Le fichier llms.txt est un standard proposé fin 2024 et adopté progressivement par Anthropic, OpenAI et Perplexity. Format markdown, placé à la racine du site (tonsite.com/llms.txt), il résume ton entreprise pour les LLMs en quelques centaines de mots." },
      {
        kind: "callout",
        text: "Astuce : moins de 1 % des sites québécois ont un llms.txt en mai 2026. Le publier maintenant te place dans le 1 % des sites « LLM-ready ». C'est un signal direct aux modèles que ton contenu mérite d'être lu.",
      },
      { kind: "p", text: "Structure type d'un llms.txt pour une PME québécoise :" },
      {
        kind: "ul",
        items: [
          "**Titre H1** : nom de l'entreprise + tagline courte",
          "**Description** : 80-120 mots citation-ready qui résument l'offre",
          "**Section Services** : liste des services principaux avec URL",
          "**Section Blog** : 5-10 articles de référence avec URLs",
          "**Section Contact** : URL contact + email",
          "**Section À propos** : 50-80 mots sur le fondateur, la localisation",
        ],
      },
      { kind: "p", text: "MAAD-AI publie son [llms.txt](https://www.maad-ai.com/llms.txt) qui sert de référence aux PME québécoises qui veulent voir un exemple concret. Tu peux copier la structure et l'adapter à ton entreprise en 30 minutes." },
      { kind: "h2", text: "Stats clés ChatGPT et IA en 2026 — le contexte chiffré" },
      { kind: "p", text: "Pour comprendre l'urgence du GEO en 2026, voici les chiffres clés. Sources : Semrush, Ahrefs, OpenAI, Statistique Canada (2026)." },
      {
        kind: "stats",
        items: [
          { value: "94 %", label: "des acheteurs B2B utilisent une IA pour pré-qualifier les fournisseurs (Semrush 2026)" },
          { value: "0,3 %", label: "des PME québécoises ont une stratégie GEO formalisée (audit MAAD-AI sur 1 200 sites)" },
          { value: "+206 %", label: "trafic référé par ChatGPT en 2025 vs 2024 (OpenAI / Similarweb)" },
          { value: "47 %", label: "des recherches B2B passent par ChatGPT, Perplexity ou Claude avant Google (2026)" },
        ],
      },
      { kind: "p", text: "L'écart entre la demande (94 % des acheteurs) et l'offre (0,3 % des PME optimisées) crée la fenêtre stratégique. Toute PME québécoise qui s'y met en 2026 dispose d'un avantage de 12 à 24 mois avant que la concurrence ne rattrape — c'est l'équivalent du SEO en 2010." },
      { kind: "h2", text: "Exemples concrets — 3 PME québécoises citées par ChatGPT en 2026" },
      { kind: "p", text: "Voici 3 cas réels (anonymisés) de PME québécoises qu'on a rendues citables par ChatGPT en moins de 6 mois. Les chiffres sont mesurés via monitoring manuel (200 requêtes ciblées, 4 LLMs)." },
      { kind: "h3", text: "Cas 1 — Cabinet juridique, Westmount" },
      { kind: "p", text: "Cabinet de 6 avocats spécialisés en droit corporatif. Avant : zéro citation ChatGPT/Perplexity sur les requêtes « meilleur avocat corporatif Montréal », « cabinet droit affaires PME Québec ». Action : refonte citation-ready de 22 pages, schema FAQPage et Service complet, llms.txt, 4 articles de fond avec citations Reddit. Résultat : 11 citations ChatGPT/mois après 6 mois, 14 leads qualifiés mentionnant ChatGPT." },
      { kind: "h3", text: "Cas 2 — SaaS B2B, Plateau Mont-Royal" },
      { kind: "p", text: "Startup SaaS de gestion de projet, 12 employés. Avant : Perplexity citait 3 compétiteurs sur 5 dans les recherches « SaaS gestion projet Québec », pas eux. Action : restructuration de la documentation produit en blocs 50-80 mots, schema HowTo sur les guides d'usage, llms.txt, mentions stratégiques sur 4 médias tech francophones. Résultat : Perplexity cite la doc dans 78 % des requêtes liées après 4 mois, +28 essais gratuits/mois attribués au GEO." },
      { kind: "h3", text: "Cas 3 — Manufacturier industriel, Anjou" },
      { kind: "p", text: "PME manufacturière B2B, 35 employés. Avant : invisible ChatGPT sur les requêtes acheteurs (« fournisseur composantes X Québec »). Action : audit GEO + 18 fiches produits restructurées + schema Product complet + 1 article invité dans un média industriel québécois + 2 réponses Reddit r/Manufacturing. Résultat : 14 leads GEO en 4 mois, dont 3 conversions à 25K$+." },
      {
        kind: "callout",
        text: "Pattern commun aux 3 cas : restructuration citation-ready + schema complet + 3-5 mentions externes stratégiques. Aucun budget Google Ads ajouté. Le GEO génère du lead à coût marginal proche de zéro une fois la stratégie en place.",
      },
      { kind: "h2", text: "Erreurs fréquentes des PME québécoises qui veulent apparaître sur ChatGPT" },
      { kind: "p", text: "On a audité 50+ PME québécoises qui ont essayé seules d'apparaître sur ChatGPT sans résultats. Voici les 5 erreurs les plus fréquentes." },
      {
        kind: "ol",
        items: [
          { t: "Croire que c'est juste du SEO + plus", d: "Le SEO classique optimise pour Google. Le GEO optimise pour les LLMs. Mêmes fondations (technique, contenu de qualité), mais formats différents (paragraphes 50-80 mots vs articles 2000+ mots), KPIs différents (positions vs citations), tactiques différentes (backlinks vs mentions sources LLMs)." },
          { t: "Ignorer le schema JSON-LD", d: "Sans schema, les LLMs doivent deviner ce que ton site représente. Avec schema complet, c'est explicite. Différence mesurée : 2,3× plus de chances d'être cité. C'est un coût ponctuel pour un ROI permanent." },
          { t: "Pas de fichier llms.txt", d: "Standard adopté par Anthropic, OpenAI, Perplexity. Moins de 1 % des sites québécois en ont un. Le publier en 30 min te place dans l'élite « LLM-ready ». Ne pas en avoir = signal négatif." },
          { t: "Contenu narratif au lieu de citation-ready", d: "Les articles longs et narratifs ne se font pas extraire. Les blocs 50-80 mots avec définition + bénéfice + chiffre se font citer. Restructurer 20 pages selon ce format prend 8-12 heures et change tout." },
          { t: "Aucune citation externe", d: "Si seul ton site parle de ton entreprise, les LLMs ne te font pas confiance. Mentions stratégiques requises : Wikipédia (si éligible), Reddit, médias québécois, annuaires d'autorité, LinkedIn fondateur. Minimum 5-10 mentions qualité pour démarrer." },
        ],
      },
      { kind: "h2", text: "Combien ça coûte vraiment de faire du GEO au Québec ?" },
      { kind: "p", text: "Trois options réelles pour une PME québécoise qui veut apparaître sur ChatGPT en 2026 :" },
      {
        kind: "compare",
        left: {
          title: "Option DIY",
          items: [
            "Coût : 0 $ (mais 60-80 h de travail interne)",
            "Outils : Schema.org docs, audit gratuit ChatGPT manuel",
            "Résultats : variables, dépend de l'expertise interne",
            "Délai : 4-8 mois selon disponibilité",
            "Risque : implémentation incomplète, pas de monitoring",
          ],
        },
        right: {
          title: "Option agence GEO",
          items: [
            "Coût : 6 000 $+ refonte + 2 000-5 000 $/mo récurrent",
            "Outils : audit propriétaire, monitoring 4 LLMs, schemas",
            "Résultats : mesurables, reportés mensuellement",
            "Délai : 6-12 semaines pour la refonte initiale",
            "Avantage : focus total, pas de courbe d'apprentissage",
          ],
        },
      },
      { kind: "p", text: "Pour une PME B2B avec un panier moyen de 5 000 $+ par client, le ROI agence est généralement positif dès le 3e lead converti via GEO. Pour les business avec panier plus faible, l'option DIY peut être plus pertinente — mais elle demande de la discipline et des compétences techniques (HTML, schema, Markdown)." },
      {
        kind: "cta",
        title: "Audit GEO gratuit pour ta PME québécoise",
        text: "On scanne 200+ requêtes dans ChatGPT, Perplexity, Claude et Gemini où ton entreprise devrait apparaître. Tu reçois un rapport de 12-18 pages avec ta visibilité actuelle, les citations de tes compétiteurs, et les 3 fix prioritaires. 7 jours ouvrables, aucun engagement.",
        cta_label: "Demander mon audit gratuit",
        cta_href: "/contact",
      },
      { kind: "h2", text: "Foire aux questions — apparaître sur ChatGPT au Québec" },
      { kind: "h3", text: "Combien de temps avant que ChatGPT cite mon entreprise ?" },
      { kind: "p", text: "Sur Perplexity et ChatGPT Search (qui font du RAG en temps réel), les premières citations apparaissent en 2 à 4 semaines après la refonte citation-ready. Sur ChatGPT classique et Claude (qui s'appuient sur le training data), il faut compter 6 à 18 mois selon le cycle de mise à jour des modèles. C'est pour ça qu'une stratégie GEO sérieuse travaille les deux mécanismes en parallèle. Notre [agence GEO Montréal](/agence-geo-montreal) suit les deux délais avec un reporting mensuel." },
      { kind: "h3", text: "Mon site WordPress / Wix peut-il faire du GEO ?" },
      { kind: "p", text: "Oui, mais avec des contraintes. WordPress permet d'ajouter des plugins schema (Yoast, Rank Math) et un fichier llms.txt manuellement — c'est 80 % du chemin. Wix et Squarespace permettent du schema basique mais limitent llms.txt et les Core Web Vitals. Pour des résultats GEO sérieux à long terme, on recommande Next.js ou WordPress optimisé. Notre service [conception web](/services/conception-web) inclut systématiquement la stack GEO-ready." },
      { kind: "h3", text: "Le GEO peut-il remplacer ma stratégie SEO Google ?" },
      { kind: "p", text: "Non. Le GEO complète le SEO, il ne le remplace pas. Le SEO classique bâtit l'autorité de domaine et le crawl Google — sans cette fondation, les LLMs ne reconnaissent pas ton site comme source fiable. La stratégie 2026 combine SEO (positions Google), [AEO](/services/aeo) (réponses directes Google AI Overviews) et [GEO](/services/geo) (citations ChatGPT/Perplexity). Le SEO reste critique mais devient insuffisant seul." },
    ],
  },
  {

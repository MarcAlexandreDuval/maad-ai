...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPaths: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
    ...
    { path: "/secteurs", priority: 0.85, changeFrequency: "monthly" },
    ...
    { path: "/agence-ia-lanaudiere", priority: 0.95, changeFrequency: "monthly" },
    { path: "/agence-ia-joliette", priority: 0.95, changeFrequency: "monthly" },
    { path: "/agence-ia-terrebonne", priority: 0.9, changeFrequency: "monthly" },

...
export const metadata = buildMetadata({
  title: "Site Web Québec — AEO/GEO ready",
  description:
    "Sites web pour PME québécoises codés main avec Claude Code. Rapides, SEO + AEO + GEO intégrés dès la conception. Pas de templates.",
